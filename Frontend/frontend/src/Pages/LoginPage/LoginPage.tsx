          ...
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              ...
              <span className="mt-15 inline-block">
                <img src="https://img.freepik.com/free-vector/transactional-marketing-abstract-concept_335657-3068.jpg?t=st=1719655012~exp=1719658612~hmac=d0d533cbd1a3a59db297d8aaf0d8116b7580c518e134437166c93de2eac32e1c&w=826"></img>
              </span>
            </div>
          </div>
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <form onSubmit={handleSubmit(handleLogin)} className="space-y-5">
                ...
                <button className="flex w-full items-center justify-center gap-3.5 border border-stroke bg-gray p-4 hover:bg-opacity-50 dark:border-strokedark dark:bg-meta-4 dark:hover:bg-opacity-50">
                  <span>
                    <svg
                      width="20"
                      height="20"
